...
public class ActionSensorSpinnerAdapter extends ArrayAdapter<Sensor>{
    private Context context;
    private int groupId;
    private List<Sensor> sensorList;

    public ActionSensorSpinnerAdapter(Context context, int groupId, int id, List<Sensor> sensorList){
