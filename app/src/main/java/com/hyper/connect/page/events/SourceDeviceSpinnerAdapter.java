...
public class SourceDeviceSpinnerAdapter extends ArrayAdapter<Device>{
    private Context context;
    private int groupId;
    private List<Device> deviceList;

    public SourceDeviceSpinnerAdapter(Context context, int groupId, int id, List<Device> deviceList){
