...
public class ActionAttributeSpinnerAdapter extends ArrayAdapter<Attribute>{
    private Context context;
    private int groupId;
    private List<Attribute> attributeList;

    public ActionAttributeSpinnerAdapter(Context context, int groupId, int id, List<Attribute> attributeList){
